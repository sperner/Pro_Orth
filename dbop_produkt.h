...
#ifndef DBOP_PRODUKT_H
#define DBOP_PRODUKT_H
...
class DBOp_Produkt : public QDialog
{
    Q_OBJECT
public:
    DBOp_Produkt(QString Id,QWidget *parent = 0);
    ~DBOp_Produkt();
